# Portfolio Page 
This repository contains source code for a portfolio page design, initially created and assessed for Week 2 Bootcamp Challenge.
The source code contains all of the HTML and CSS code that makes up my porfolio page with some real life achievements and projects I have worked on throughout my career.

## Deploy

The final webpage for this can be accessed here: https://kevinvongmany.github.io/about-me/.
...
![portfolio demo](./docs/02-advanced-css-homework-demo.gif)
